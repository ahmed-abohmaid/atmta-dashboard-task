...
- **Pre-commit Prettier Formatting**: Before any commit, Prettier MUST be executed strictly on the changed files only (`npx prettier --write <changed-files>`). Never commit unformatted files.
