...
export const vendorSchema = z.object({
  ...
  name_en: z.string().trim().min(2, "اسم المورد بالإنجليزية مطلوب (حرفان على الأقل)"),
  about: z.string().trim().min(5, "نبذة عن المورد مطلوبة (5 أحرف على الأقل)"),
  ...
  categoryId: z.string().trim().min(1, "يرجى اختيار تصنيف للمورد"),
